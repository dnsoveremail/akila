...
// source: akila/inflation/v1/inflation.proto
...
// The initial InflationDistribution can be calculated from the Akila Token
// Model like this:
...
func (*InflationDistribution) Descriptor() ([]byte, []int) {
	return fileDescriptor_2bca4684d224b2c1, []int{0}
}
...
func (*ExponentialCalculation) Descriptor() ([]byte, []int) {
	return fileDescriptor_2bca4684d224b2c1, []int{1}
}
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "akila.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "akila.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("akila/inflation/v1/inflation.proto", fileDescriptor_2bca4684d224b2c1)
}

var fileDescriptor_2bca4684d224b2c1 = []byte{
	// 368 bytes of a gzipped FileDescriptorProto
	,
}
