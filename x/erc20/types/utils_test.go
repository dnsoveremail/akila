	...
	testCases := []struct {
	...
	}{
		{
			...
			banktypes.Metadata{
				...
				Name:        "Akila",
				Symbol:      "AKILA",
				Description: "EVM, staking and governance denom of Akila",
				DenomUnits: []*banktypes.DenomUnit{
					{
						Denom:    "aakila",
						Exponent: 0,
						Aliases:  []string{"atto akila"},
					},
					{
						Denom:    "akila",
						Exponent: 18,
...
func TestEqualAliases(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			[]string{"atto akila", "aakila"},
			[]string{"aakila", "atto akila"},
			false,
		},
		{
			"same values, sorted",
