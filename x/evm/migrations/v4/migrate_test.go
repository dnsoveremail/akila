// Copyright 2022 Akila Foundation
// This file is part of the Akila Network packages.
//
// Akila is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// The Akila packages are distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with the Akila packages. If not, see https://github.com/akila/akila/blob/main/LICENSE
package v4_test
...
import (
	...
	v4types "akila/x/evm/migrations/v4/types"
