...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "akila_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "AKILA_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Akila_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "akila_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "akila_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "akila_akila_9000-1", true, nil,
		},
		{
			"invalid epoch, undefined", "akila_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "akila_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
