...
# Initialize chain.
akilad init test --chain-id akila_9000-2

# Get Genesis
wget https://archive.akila.org/mainnet/genesis.json
mv genesis.json ~/.akilad/config/

wget -O ~/.akilad/config/adrbook.json https://snapshot.notional.ventures/akila/addrbook.json
...
export AKILAD_P2P_MAX_NUM_INBOUND_PEERS=200
export AKILAD_P2P_MAX_NUM_OUTBOUND_PEERS=200
export AKILAD_STATESYNC_RPC_SERVERS="https://akila-rpc.polkachu.com:443,https://rpc-akila-ia.notional.ventures:443"
